<template>
    <div class="navbar">
        ...
        <div class="right-menu flex align-center">
            <i class="el-icon-user marginR-10" />
            <span class="marginR-10">{{ name }}</span>
            <el-dropdown class="avatar-container" trigger="click">
                ...
                <el-dropdown-menu slot="dropdown" class="user-dropdown">
                    ...
                    <el-dropdown-item @click.native="modPasswd">
    ...
    methods: {
        ...
        async modPasswd() {
            this.$prompt('请输入新密码', '重置密码', {
                ...
                const data = await this.$fetch('/resetPassword', {user_password: value})
                if(data.status == 0) {
